...
const fetchRecipes = (req, res, response) => {
    try {
        ...
        res.send({
            // method : req.method,
            // status : true,
            "info" : "daftar resep makanan",
            'resep makanan' : recipe_list
        });
    } catch (error) {
        throw error;
    }
...
const Controller = {
    ...
    category : async (req, res) => {
        try {
            ...
            return res.send({
                "info" : "resep-resep berdasarkan kategori",
                "resep makanan" : category_list
            });
    ...
    article : async (req, res) => {
        try {
            ...
            return res.send({
                info : "Daftar Artikel Mengenai Resep - Resep Makanan",
                "Daftar Artikel Resep Makanan" : article_lists
            });
        } catch (error) {
            throw error;
        }
    ...
    articleCategory : async (req, res) => {
        try {
            ...
            res.send({
                info : "Daftar Artikel & Kategorinya!",
                "Artikel Resep Makanan" : article_category_list
            });
    ...
    articleByCategory : async (req, res) => {
        try {
            ...
            res.send({
                info : "Daftar Artikel Resep Makanan Kategori "+req.params.key,
